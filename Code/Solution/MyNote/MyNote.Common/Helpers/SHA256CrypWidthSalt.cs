...
{
    public class SHA256CrypWidthSalt
    {
        ...
        public SHA256CrypWidthSalt(string _source, string _salt, string _hasString)
        {
            this.source = _source;
            this.salt = _salt;
        ...
        public static SHA256CrypWidthSalt Encrypt(string source)
        {
            ...
            return new SHA256CrypWidthSalt(source, salt, hashString);
        }
