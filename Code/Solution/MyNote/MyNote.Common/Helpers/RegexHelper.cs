...
namespace MyNote.Common.Helpers
{
    public class RegexHelper
    {
        ...
        /// Emial地址
        /// </summary>
        public const string EmailRegexStr = @"^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$";
        /// <summary>
        /// 域名
        /// </summary>
        public const string DomainRegexStr = @"[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(/.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+/.?";
        /// <summary>
        /// InternetURL
        /// </summary>
        public const string InternetURLRegexStr1 = @"[a-zA-z]+://[^\s]*";
        /// <summary>
        /// InternetURL
        /// </summary>
        public const string InternetURLRegexStr2 = @"^http://([\w-]+\.)+[\w-]+(/[\w-./?%&=]*)?$";
        /// <summary>
        /// 手机号
        /// </summary>
        public const string PhoneNumberRegexStr = @"^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$";
        /// <summary>
        /// 电话号码
        /// </summary>
        public const string TelephoneNumberRegexStr = @"^($$\d{3,4}-)|\d{3.4}-)?\d{7,8}$";
        /// <summary>
        /// 国内电话号码
        /// </summary>
        public const string InternalTelephoneNumberRegexStr = @"\d{3}-\d{8}|\d{4}-\d{7}";
        /// <summary>
        /// 身份证号(15位、18位数字)
        /// </summary>
        public const string IdentificationRegexStr = @"^\d{15}|\d{18}$";
        /// <summary>
        /// 短身份证号码(数字、字母x结尾)
        /// </summary>
        public const string IdentitficationWidthXRegexStr = @"^([0-9]){7,18}(x|X)?$ 或 ^\d{8,18}|[0-9x]{8,18}|[0-9X]{8,18}?$";
        /// <summary>
        /// 帐号是否合法(字母开头，允许5-16字节，允许字母数字下划线)
        /// </summary>
        public const string AccountRegexStr = @"^[a-zA-Z][a-zA-Z0-9_]{4,15}$";
        /// <summary>
        /// 密码(以字母开头，长度在6~18之间，只能包含字母、数字和下划线)
        /// </summary>
        public const string PasswordRegexStr = @"^[a-zA-Z]\w{5,17}$";
        /// <summary>
        /// 强密码(必须包含大小写字母和数字的组合，不能使用特殊字符，长度在8-10之间)
        /// </summary>
        public const string StrongPasswordRegexStr = @"^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,10}$";
        /// <summary>
        /// 日期格式
        /// </summary>
        public const string DateTimeRegexStr = @"^\d{4}-\d{1,2}-\d{1,2}";
        /// <summary>
        /// 一年的12个月(01～09和1～12)
        /// </summary>
        public const string MonthRegexStr = @"^(0?[1-9]|1[0-2])$";
        /// <summary>
        /// 一个月的31天(01～09和1～31)
        /// </summary>
        public const string DayRegexStr = @"^((0?[1-9])|((1|2)[0-9])|30|31)$";
        /// <summary>
        /// 有四种钱的表示形式我们可以接受:”10000.00″ 和 “10,000.00”, 和没有 “分” 的 “10000” 和 “10,000”
        /// </summary>
        public const string MoneyRegexStr = @"^[1-9][0-9]*$";
        /// <summary>
        /// 这表示任意一个不以0开头的数字，但是，这也意味着一个字符”0″不通过，所以我们采用下面的形式
        /// </summary>
        public const string NumberHeadIsNot0AndNot0RegerStr = @"^(0|[1-9][0-9]*)$";
        /// <summary>
        /// 一个0或者一个不以0开头的数字.我们还可以允许开头有一个负号
        /// </summary>
        public const string NumberHeadIsNot0RegerStr = @"^(0|-?[1-9][0-9]*)$";
        /// <summary>
        /// 这表示一个0或者一个可能为负的开头不为0的数字.让用户以0开头好了.把负号的也去掉，因为钱总不能是负的吧
        /// </summary>
        public const string NumberCanBeNegativeRegerStr = @"^[0-9]+(.[0-9]+)?$";
        /// <summary>
        /// 必须说明的是，小数点后面至少应该有1位数，所以”10.”是不通过的，但是 “10” 和 “10.2” 是通过的
        /// </summary>
        public const string DecimalNumberRegerStr = @"^[0-9]+(.[0-9]{2})?$";
        /// <summary>
        /// xml文件
        /// </summary>
        public const string XmlFileRegerStr = @"^([a-zA-Z]+-?)+[a-zA-Z0-9]+\\.[x|X][m|M][l|L]$";
        /// <summary>
        /// 中文字符的正则表达式
        /// </summary>
        public const string ChineseCharRegerStr = @"[\u4e00-\u9fa5]";
        /// <summary>
        /// 双字节字符
        /// </summary>
        public const string DoubleByteCharRegerStr = @"[^\x00-\xff]";
        /// <summary>
        /// 空白行的正则表达式，可用来删除空白行
        /// </summary>
        public const string BlankRowRegerStr = @"\n\s*\r";
        /// <summary>
        /// HTML标记的正则表达式(这个也仅仅能部分，对于复杂的嵌套标记依旧无能为力)
        /// </summary>
        public const string HtmlMarkupRegerStr = @"<(\S*?)[^>]*>.*?</\1>|<.*? />";
        /// <summary>
        /// 首尾空白字符的正则表达式(可以用来删除行首行尾的空白字符(包括空格、制表符、换页符等等)，非常有用的表达式))
        /// </summary>
        public const string HeadTailWidthBlankREgerStr = @"^\s*|\s*$或(^\s*)|(\s*$)";
        /// <summary>
        /// 腾讯QQ号
        /// </summary>
        public const string QQNumberRegerStr = @"[1-9][0-9]{4,}";
        /// <summary>
        /// 中国邮政编码(中国邮政编码为6位数字)
        /// </summary>
        public const string ChinaPostCodeRegerStr = @"[1-9]\d{5}(?!\d)";
        /// <summary>
        /// IP地址(提取IP地址时有用)
        /// </summary>
        public const string IPRegerStr = @"\d+\.\d+\.\d+\.\d+";
        /// <summary>
        /// IP地址
        /// </summary>
        public const string StrongIPRegerStr = @"((?:(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d)\\.){3}(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d))";
        ...
        public static bool IsGuid(string source)
        {
            ...
            Match match = Regex.Match(source, @"^[0-9a-f]{8}(-[0-9a-f]{4}){3}-[0-9a-f]{12}$", RegexOptions.IgnoreCase);
        ...
        public static bool IsPort(string source)
        {
            ...
            return Regex.IsMatch(source, @"[0-9]|[1-9]\d{1,3}|[1-5]\d{4}|6[0-5]{2}[0-3][0-5]");
        }
