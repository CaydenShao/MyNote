...
{
    public class SHA384CrypWidthSalt
    {
        ...
        public SHA384CrypWidthSalt(string _source, string _salt, string _hasString)
        {
            this.source = _source;
            this.salt = _salt;
        ...
        public bool CanMatch
        {
            get
            {
                ...
                byte[] hashBytes = new SHA384Managed().ComputeHash(passwordAndSaltBytes);
        ...
        public static SHA384CrypWidthSalt Encrypt(string source)
        {
            ...
            return new SHA384CrypWidthSalt(source, salt, hashString);
        }
